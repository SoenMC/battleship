 ...
 */
export declare type JwkToKeyObjectTransformerSync = (jwk: Jwk, alg?: SupportedSignatureAlgorithm, issuer?: string, kid?: string) => GenericKeyObject;
/**
...
export declare class KeyObjectCache {
    ...
    transformJwkToKeyObjectAsync(jwk: Jwk, issuer?: Issuer): Promise<GenericKeyObject>;
